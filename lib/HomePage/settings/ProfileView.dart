...
import 'package:systemevents/CustomWidget/checkInternet.dart';
...
class _ProfilePageState extends State<ProfilePage> {
        ...
        if(value !=null)
          {
            state=true;
              ...
              _image=null;
              _uri=witness!=null?"http://192.168.1.3:8000${witness.image}":null;
 ...
 // }
  ...
  void setDataForm( ) {
    ...
    :Provider.of<UserAuthProvider>(context,listen: false).user.setDate_of_birth="1960-01-01 00:00:00.000"
    ;
    ...
    try{
      ...
      if (result != null  ) {
        ...
        Map data={
         ...
         bool res = await Provider.of<UserAuthProvider>(context,listen: false).updateProfileData(data);
        if(res==true)
          _scaffoldKey.currentState.showSnackBar(SnackBar(
