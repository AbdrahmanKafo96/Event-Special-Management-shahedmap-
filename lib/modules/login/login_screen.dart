                                  ...
                                  Row(
                                    ...
                                    children: [
                                      TextButton(
                                        ...
                                        child:  Row(
                                          children: [
                                            Padding(padding: EdgeInsets.only(bottom: 5,right: 1,left: 1),
                                      ...
                                      TextButton(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text(  val == PageState.reg ? "لدي حساب!" : 'لا تملك حساب!',
                                              style: TextStyle(
                                              color: Colors.orange, fontSize: 14,
                                              decoration: TextDecoration.underline,
                                            ),),
...
// L login  , R Register  ...
                                        userdata = val == PageState.login
                                          ...
                                          'email': Provider.of<UserAuthProvider>(context,
                                              listen: false)
                                              .user
                                              .getEmail
                                              .toString(),
                                          ...
                                          'country': Provider.of<UserAuthProvider>(
                                              ...
                                              .getCountry
                                              .toString(),
                                          'date_of_birth': Provider.of<UserAuthProvider>(
                                              context,
                                              listen: false)
                                              .user
                                              .getDate_of_birth
...
// value:  ,
                                      ...
                                      child:  Row(
                                        ...
                                        children: [
                                          Padding(padding: EdgeInsets.only(bottom: 3,right: 2,left: 2),
                                            child:Icon(
                                             FontAwesomeIcons.signIn,
                                              color: Theme.of(context).iconTheme.color,
                                            ) ,),
                                          Text(  val == PageState.reg ? "إنشاء حساب" : 'تسجيل الدخول',
                                              style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 16,
