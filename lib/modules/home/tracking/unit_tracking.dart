...
//   }
//
//   Future<void> getIniLocation(loc.LocationData locationData , BuildContext context) async {
//     try {
...
//             zoom: 18,
//           );
//           getIniLocation(currentPos , context);
//         });
...
//       loc.LocationData locationData, BuildContext context) async {
...
//
//       // double  time=(distance/(locationData.speedAccuracy)) /3600;
//       data = {
...
//
//         if (data.isNotEmpty) //distance > distance * 1000 > 5.0
//         {
...
//                           } else {
//                             if (senderID != null) {
//                               // we need also update mission tracking
//                               checkInternetConnectivity(context).then((bool value) async {
//                                 if(value){
...
//               //     .listen(( position) {
//               //       print("inside listen fun ${position.latitude}");
//               // if (controller != null) {
//               //   _lat_startpoint = position.latitude;
//               //   _lng_startpoint = position.longitude;
//               //
